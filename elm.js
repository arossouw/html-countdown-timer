...
var _user$project$Main$view = function (model) {
	var second = (_elm_lang$core$Native_Utils.cmp(
		A2(_elm_lang$core$Basics_ops['%'], model.count, 60),
		10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(
			A2(_elm_lang$core$Basics_ops['%'], model.count, 60))) : _elm_lang$core$Basics$toString(
		A2(_elm_lang$core$Basics_ops['%'], model.count, 60));
	var minute = (_elm_lang$core$Native_Utils.cmp(
		(A2(_elm_lang$core$Basics_ops['%'], model.count, 3600) / 60) | 0,
		10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(
			(A2(_elm_lang$core$Basics_ops['%'], model.count, 3600) / 60) | 0)) : _elm_lang$core$Basics$toString(
		(A2(_elm_lang$core$Basics_ops['%'], model.count, 3600) / 60) | 0);
	var hour = (_elm_lang$core$Native_Utils.cmp((model.count / 3600) | 0, 10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString((model.count / 3600) | 0)) : _elm_lang$core$Basics$toString((model.count / 3600) | 0);
	return A2(
...
var _user$project$Main$CountDownTimer = F3(
	function (a, b, c) {
